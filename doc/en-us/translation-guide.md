...
None. This package is headless shared infrastructure, so every term it needs is cross-cutting
and lives in Section 5.1. Do not add UI or app-domain vocabulary here.
